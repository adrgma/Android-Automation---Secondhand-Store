...
WebUI.callTestCase(findTestCase('Pages/page_home/click_beranda_menu'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/page_pencarian/input_nama_produk'), [('nama_produk') : product_name], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/page_home/navigate_to_see_produklangsung_tolak'), [:], FailureHandling.STOP_ON_FAILURE)
